...
| File                | Summary                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Module                    |
|:--------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:--------------------------|
| docker_build.sh     | This Bash script aims to clean and build two Docker images:'negan/clipboard-mongo:rasp4' and'negan/clipboard-webapp:rasp4'. It first removes any existing images with the given names. Then, it builds a Docker image for the MongoDB database using the'../mongo-init' directory, tags it with the given name and pushes it to Docker Hub. Lastly, it builds a Docker image for the web application using the'../backend-app' directory, tags it with the given name and also pushes it to Docker Hub. | local/docker_build.sh     |
